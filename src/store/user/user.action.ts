...
export type SignInSucess = ActionWithPayload<USER_ACTION_TYPES.SIGN_IN_SUCESS, UserData>;

export type SignInFailed = ActionWithPayload<USER_ACTION_TYPES.SIGN_IN_FAILED, Error>;

export type SignUpSucess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: UserData, additionalDetails: AdditionalInformation }>;
...
export const signInSuccess = (user: UserData & { id: string }) => createAction(USER_ACTION_TYPES.SIGN_IN_SUCCESS, user);
